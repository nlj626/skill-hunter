...
全渠道 Claude Code Skill 搜索器 — 覆盖 6 大渠道、36,000+ Skill，搜索结果按可信度排序并支持一键安装。
...
| 特性 | 说明 |
|------|------|
| 多渠道搜索 | GitHub API (36K+)、skills.sh、awesome 列表、ClawHub、SkillsMP |
...
A multi-channel Claude Code Skill search tool — covering 6 channels, 36,000+ skills, with credibility-ranked results and one-click installation.
...
| Feature | Description |
|---------|-------------|
| Multi-channel Search | GitHub API (36K+), skills.sh, awesome lists, ClawHub, SkillsMP |
